...
namespace Sum {
  public static partial class SumService
  {
    ...
    static readonly grpc::Method<global::Sum.SumRequest, global::Sum.SumResponse> __Method_SumNumbers = new grpc::Method<global::Sum.SumRequest, global::Sum.SumResponse>(
    ...
    {
      public virtual global::System.Threading.Tasks.Task<global::Sum.SumResponse> SumNumbers(global::Sum.SumRequest request, grpc::ServerCallContext context)
      {
    ...
    public partial class SumServiceClient : grpc::ClientBase<SumServiceClient>
    {
      ...
      public virtual global::Sum.SumResponse SumNumbers(global::Sum.SumRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return SumNumbers(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual global::Sum.SumResponse SumNumbers(global::Sum.SumRequest request, grpc::CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_SumNumbers, null, options, request);
      }
      public virtual grpc::AsyncUnaryCall<global::Sum.SumResponse> SumNumbersAsync(global::Sum.SumRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return SumNumbersAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      public virtual grpc::AsyncUnaryCall<global::Sum.SumResponse> SumNumbersAsync(global::Sum.SumRequest request, grpc::CallOptions options)
      {
    ...
    {
      serviceBinder.AddMethod(__Method_SumNumbers, serviceImpl == null ? null : new grpc::UnaryServerMethod<global::Sum.SumRequest, global::Sum.SumResponse>(serviceImpl.SumNumbers));
    }
